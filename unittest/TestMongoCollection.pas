...
uses Variants, SysUtils, Math, BSONTypes, MongoUtils, BSON, MongoMD5, BSONDBRef;
...
begin
  ...
  vDBRef := TBSONDBRef.NewFrom(DefaultCollection, vId);

  vDocRef := vDBRef.Fetch();
